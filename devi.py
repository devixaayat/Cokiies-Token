# Decompile by  (DEVI)
# Time Succes decompile : 2022-05-02 07:23:50.374444
import os,sys
try: import requests
...
from requests.exceptions import ConnectionError
try:os.remove("devi.txt")
except:pass
try:os.remove("devi2.txt")
except:pass
try:
	os.mkdir('dump')
except:pass
...
class pilih_alam:
	def __init__(self):
		...
		if pil_b == "y" or pil_b == "Y":
			jalan(war+"If there is Uncle Garookx's voice, it's a sign that the crack results are out");jalan(war+"Example ...");alam = ("y");play_mpv('hello mr devi tool use take care.mp3')
		else:
			alam = ("Garoookkxxx")
class pilih_infong:
	def __init__(self):
...
==================================================
           CREATE BY : DEVI DON      
           WHATSAPP : 03263342276    
           FB ID  : 乛Mʀ Dɘv'ɩ O.oメ  
==================================================           
              \x1b[1;41m\x1b[1;97mK1NG BARAND \x1b[1;0m"""
...
╚═════╝ ╚══════╝  ╚═══╝  ╚═╝
 ...
 [*]=============================================
    \x1b[0;91m\x1b[1;43m                  MAKED BY DEVI:)                 \x1b[0m
 [*]=============================================
    \033[1;32m  Use Airplane ✈️ mood if no result \033[1;32m
 [*]============================================="""
...
class dubb:
	def __init__(self):
		...
		os.system('sort -r "'+file+'" | uniq > /sdcard/devi')
		...
		print ("[DEVI] Removing successfully ..")
		print ("[DEVI] Your file path : /storage/emulated/0/Xdevi.txt")
		print(47*'\033[1;97m-\033[0;0m')
		input ("\n[?] Retrun back menu")
		os.system("python Extract.py")
class login:
...
class msort:
	def __init__(self):
		...
		os.system('sort -r /sdcard/1.txt | uniq > /sdcard/devi.txt')
		os.system('rm -rf /sdcard/1.txt')
		os.system('rm -rf /sdcard/devi.txt.txt')
		os.system('rm -rf /sdcard/deviidz.txt')
		print(47*'\033[1;97m-\033[0;0m')
